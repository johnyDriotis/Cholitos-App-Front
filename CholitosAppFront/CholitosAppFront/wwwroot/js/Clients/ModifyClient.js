        ...
        $.ajax({
            ...
            success: function (resp) {
                if (resp.errorGenerado == null && resp.generoError == false) {
                    showNotification('alert-success', 'Cliente actualizado correctamente', 'top', 'center');
                }
                else {
                    showNotification('alert-danger', 'Ocurrio un error al actualizar el cliente', 'top', 'center');
                }
            },
